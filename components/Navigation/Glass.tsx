...
export const NavBarGlass = () => {
    const navClass = `fixed bottom-5 left-1/2 -translate-x-1/2 md:bottom-auto md:top-10 md:left-auto md:translate-x-0 md:right-10 px-5 py-2.5 w-fit z-100 ${navShellClassName} `;
